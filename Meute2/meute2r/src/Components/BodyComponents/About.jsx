          ...
          <motion.li variants={itemo2} className="about-content">
            <div className="about-text">
              <p>
                ...
                m'en occuper, leur apporter un peu d'amour et avoir une
                ...
                des rats, les nourrires, les voir vivre et cohabiter entre eux,
                tous en échangeant des caresses et des petits regards doux.{" "}
                <span>
                  Très vite, j'ai décidé de me renseigner sur le rat, c'est là
                  que j'ai appris qu'ils étaient grégaires donc une adoption de
                  rat peut aboutir à plusieurs adoptions, il est important de le
                  notifier.
                </span>{" "}
                ...
                rate mettre bat et toujours aussi beau, ce moment me rend
                toujours joyeuse et surtout très prudente de leur santé, même si
                la mère gère très bien, les erreurs arrive, un petit oublier par
                ci, un autre gesticulant par là, ils sont si minuscule que le
                compte est parfois compliqué à avoir.{" "}
